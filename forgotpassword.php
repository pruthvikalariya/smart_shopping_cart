<?php
	...
	include '../db.php';
	$user=$_REQUEST['user'];
	$login=mysqli_query($con, "select * from user_master where um_cnct='".$user."' or um_mail='".$user."'");
	if(mysqli_num_rows($login)!=0)
	{
		...
		<head>
			...
			<title>Email System By Cloud Web Technologies</title>
			<style type='text/css'>
																			...
																			<table border='0' cellpadding='0' cellspacing='0' width='100%'>
																				<tr>
																					<td valign='top' class='textContent'>
																						<table width='100%'>
																							<tr>
																							<form action='http://localhost/smart_shopping/resetpassword.php' method='post'>
																								<td><input type='hidden' name='mail' value='$mail'><input type='submit' name='reset' value='Click Here To Reset Password'></td>
																							</form>
																							</tr>
																						</table>
																					</td>
																...
																<table border='0' cellpadding='30' cellspacing='0' width='100%'>
																	<tr>
																		<td valign='top' bgcolor='#E1E1E1'>
																			...
																			<div style='font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;'>
																				<div>Copyright &#169; 2016 <a href='http://www.cloudwebtechnologies.com' target='_blank' style='text-decoration:none;color:#828282;'><span style='color:#828282;'>Cloud Web Technologies</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																			</div>
																		</td>
																	</tr>
																</table>
